...
var express    	= require('express'), //call express
	...
	User	   	= require('./app/models/user'), //users models to here
	port	   	= process.env.PORT || 8080; // set the port for our app

var jwt = require('jsonwebtoken'),	//json web token (Oauth - https://jwt.io/)
	superSecret = 'ilovescotchscotchyscotchscotch'; //a Secret key to Create Tokens With(signature part)
